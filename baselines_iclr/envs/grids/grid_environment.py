...
class OfficeEnv(GridEnv):
    ...
    def reset(self):
        self.env.reset()
        self.env.agent = random.randint(0,self.env.map_height-1), random.randint(0,self.env.map_width-1)
        return self.env.get_features()
