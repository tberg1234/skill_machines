...
do
	...
	# Rebutal task 1
	python run.py --alg=smql --env=Office-new-up-rm1-v0 --num_timesteps=400000 --qinit=0.001 --gamma=0.9 --epsilon 0.5 --print_freq 10000 --init_eval --sp data/spql_up_$i --log_path=data/logs/sm-ql/zeroshot/Office-Multi-Task-v0/$i
