...
do
        ...
        python sm_ql.py --env Office-Mod-CoffeeStrict-Task-v0 --total_steps 400000 --zeroshot --load --sp_dir data/sp_ql/Office-Mod-v0/$i/ --log_dir data/logs/sm_ql/zeroshot/Office-Mod-CoffeeStrict-Task-v0/$i/        python sm_ql.py --env Office-Mod-CoffeeStrict-Task-v0 --total_steps 400000 --fewshot --load --sp_dir data/sp_ql/Office-Mod-v0/$i/ --log_dir data/logs/sm_ql/fewshot/Office-Mod-CoffeeStrict-Task-v0/$i/
