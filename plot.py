...
parser.add_argument(
    '--exp',
    default="office",
    help="Experiment. E.g office, movingtargets",
)
...
def plot_office():
    ...
    # dirs = ['sm_ql/zeroshot','sm_ql/fewshot','crm','crm-rs','hrm','hrm-rs','ql','ql-rs']
    ...
    for j in range(len(labels)):
        ...
        episodes, steps, performance = all_data_pnts[0].index("episodes"), all_data_pnts[0].index("steps"), all_data_pnts[0].index("successes")
        ...
        for i in range(num_runs):
            try:
                ...
                episodes, steps, performance = data_pnts[0].index("episodes"), data_pnts[0].index("steps"), data_pnts[0].index("successes")
