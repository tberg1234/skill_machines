...
do
	(
	# Primitives
	python run.py --alg=spql --env=Office-new-v0 --num_timesteps=100000 --gamma=0.9 --epsilon 0.5 --print_freq 1000 --sp data/spql_$i
	python run.py --alg=spql --env=Office-new-v0 --num_timesteps=100000 --gamma=0.9 --epsilon 0.5 --print_freq 1000 --sp data/spql_$i

	# RM1 task
	python run.py --alg=smql --env=Office-new-rm1-v0 --num_timesteps=400000 --gamma=0.9 --epsilon 0.5 --print_freq 1000 --init_eval --sp data/spql_$i --log_path=data/logs/sm-ql/zeroshot/Office-Coffee-Task-v0/$i
        python run.py --alg=smql --env=Office-new-rm1-v0 --num_timesteps=400000 --gamma=0.9 --epsilon 0.5 --print_freq 1000 --init_eval --sp data/spql_$i --use_csm --log_path=data/logs/sm-ql/fewshot/Office-Coffee-Task-v0/$i
	...
	# RM3 task
	 python run.py --alg=smql --env=Office-new-rm3-v0 --num_timesteps=400000 --gamma=0.9 --epsilon 0.5 --print_freq 1000 --init_eval --sp data/spql_$i --log_path=data/logs/sm-ql/zeroshot/Office-CoffeeMail-Task-v0/$i
	 python run.py --alg=smql --env=Office-new-rm3-v0 --num_timesteps=400000 --gamma=0.9 --epsilon 0.5 --print_freq 1000 --init_eval --sp data/spql_$i --use_csm --log_path=data/logs/sm-ql/fewshot/Office-CoffeeMail-Task-v0/$i
	...
	# rm4 task
	python run.py --alg=smql --env=Office-new-rm4-v0 --num_timesteps=400000 --gamma=0.9 --epsilon 0.5 --print_freq 1000 --init_eval --sp data/spql_$i --log_path=data/logs/sm-ql/zeroshot/Office-Long-Task-v0/$i
	python run.py --alg=smql --env=Office-new-rm4-v0 --num_timesteps=400000 --gamma=0.9 --epsilon 0.5 --print_freq 1000 --init_eval --sp data/spql_$i --use_csm --log_path=data/logs/sm-ql/fewshot/Office-Long-Task-v0/$i
	...
	# Multi-task
	python run.py --alg=smql --env=Office-new-multiple-v0 --num_timesteps=400000 --gamma=0.9 --epsilon 0.5 --print_freq 1000 --init_eval --sp data/spql_$i --log_path=data/logs/sm-ql/zeroshot/Office-Multi-Task-v0/$i
	python run.py --alg=smql --env=Office-new-multiple-v0 --num_timesteps=400000 --gamma=0.9 --epsilon 0.5 --print_freq 1000 --init_eval --sp data/spql_$i --use_csm --log_path=data/logs/sm-ql/fewshot/Office-Multi-Task-v0/$i
	...
	# Rebutal task 1
	python run.py --alg=smql --env=Office-new-up-rm1-v0 --num_timesteps=400000 --gamma=0.9 --epsilon 0.5 --print_freq 1000 --init_eval --sp data/spql_$i --log_path=data/logs/sm-ql/zeroshot/Office-Multi-Task-v0/$i
	python run.py --alg=smql --env=Office-new-up-rm1-v0 --num_timesteps=400000 --gamma=0.9 --epsilon 0.5 --print_freq 1000 --init_eval --sp data/spql_$i --use_csm --log_path=data/logs/sm-ql/fewshot/Office-Mod-Coffee-Task-v0/$i
	...
	# Rebutal task 2
	python run.py --alg=smql --env=Office-new-rm5-v0 --num_timesteps=400000 --gamma=0.9 --epsilon 0.5 --print_freq 1000 --init_eval --sp data/spql_$i --log_path=data/logs/sm-ql/zeroshot/Office-Mod-CoffeeStrict-Task-v0/$i
	python run.py --alg=smql --env=Office-new-rm5-v0 --num_timesteps=400000 --gamma=0.9 --epsilon 0.5 --print_freq 1000 --init_eval --sp data/spql_$i --use_csm --log_path=data/logs/sm-ql/fewshot/Office-Mod-CoffeeStrict-Task-v0/$i
