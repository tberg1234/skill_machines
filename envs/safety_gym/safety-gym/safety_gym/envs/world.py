...
class World:
    ...
    def build(self):
        ...
        # # Make sure floor renders the same for every world ### CHANGED
        # self.episode += 1
        # g = self.xml['mujoco']['default']['geom']
        # if self.episode == 2: # removes ghost at the beginning of trajectory render 
        #     g.update({'@rgba': '1 0 0 0'})
        # # if self.episode == 3: # green trajectory render
        # #     g.update({'@rgba': '0 1 0 1'})
        # # if self.episode == 4: # blue trajectory render
        # #     g.update({'@rgba': '0 0 1 1'})
