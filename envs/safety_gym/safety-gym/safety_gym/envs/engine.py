...
class Engine(gym.Env, gym.utils.EzPickle):
    ...
    DEFAULT = {
        ...
        'robot_s': [],  # Fixed locations to override placements
    ...
    def render(self,
        ...
        if self.task == 'button':
            ...
            self.render_area(self.goal_pos, self.buttons_size * 2, COLOR_RED, 'goal', alpha=0.5) ### CHANGED
